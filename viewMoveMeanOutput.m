...
function average_arr=viewMoveMeanOutput(dir_name,move_range,xlim_pos,ylim_pos,show_graph,save_fig,scale_x,scale_y,translate_x,translate_y)
    ...
    writematrix(horzcat(units, average_arr), strcat(dir_name,'/ave.txt'));
end